...
def run_eval(args, save_dir):
    ...
    dyn_models = Dyn_Model(inputSize, outputSize, acSize, params=params)
    ...
    dyn_models = torch.load(restore_path)
    print("\n\nModel restored from ", restore_path, "\n\n")

    #restore mean/std
    dyn_models.normalization_data = normalization_data
    # print(normalization_data.mean_x)
    # print(dyn_models.normalization_data.mean_x)
